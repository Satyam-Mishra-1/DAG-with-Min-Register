  ...
  return (
    <Card className="mt-8">
      <CardContent className="p-4">
        <h3 className="text-xl font-bold mb-4">Optimization Process</h3>
        
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid grid-cols-5 mb-6">
            <TabsTrigger 
              value="copy-prop"
              className="data-[state=active]:bg-optimization-copyProp data-[state=active]:text-white">
              Copy Propagation
            </TabsTrigger>
            <TabsTrigger 
              value="const-prop"
              className="data-[state=active]:bg-optimization-constProp data-[state=active]:text-white">
              Constant Propagation
            </TabsTrigger>
            <TabsTrigger 
              value="const-fold"
              className="data-[state=active]:bg-optimization-constFold data-[state=active]:text-white">
              Constant Folding
            </TabsTrigger>
            <TabsTrigger 
              value="cse"
              className="data-[state=active]:bg-optimization-cse data-[state=active]:text-white">
              CSE
            </TabsTrigger>
            <TabsTrigger 
              value="dead-code"
              className="data-[state=active]:bg-optimization-deadCode data-[state=active]:text-white">
              Dead Code
            </TabsTrigger>
          </TabsList>
